...
public class Constants {
    ...
    //汉英词典路径
    public static final String CHINESE_ENGLISH_DIC_PATH=ROOT_PATH+"/ChineseDictionary.db";
    //成语词典路径
    public static final String IDIO_DIC_PATH=ROOT_PATH+"/ChineseDictionary.db";
